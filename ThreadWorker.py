...
class SolutionSuscriberThread(Thread):    
    ...
    def __init__(self, 
        ...
        self.vertical_res= 480/50 ## Resolucion vertical de la camara [Pixel/°]
        self.horizontal_res= 640/73 ## Resolucion horizontal de la camara [Pixel/°]
        #################################################
        ...
        while self._run_flag:
            ...
            if self.socket in socks and socks[self.socket] == zmq.POLLIN:
                ...
                if (not self.last_solution_data.solution_array):
                    ...
                    pix_vert = self.last_solution_data.solution_array[1]*self.vertical_res
                    pix_horz = self.last_solution_data.solution_array[2]*self.horizontal_res
                self.queue.put([pix_vert,pix_horz])  # Put the message into the queue
                print([pix_vert,pix_horz])
